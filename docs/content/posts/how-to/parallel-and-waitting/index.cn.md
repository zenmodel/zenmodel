---
title: "并行与等待：如何构建包含并行与等待 Neuron 的 Brain"
date: 2020-06-08T08:06:25+06:00
description: "并行与等待：如何构建包含并行与等待 Neuron 的 Brain"
menu:
  sidebar:
    name: 并行与等待
    identifier: parallel
...
完整示例见： [examples/flow-topology/parallel](https://github.com/zenmodel/zenmodel/tree/main/examples/flow-topology/parallel-and-wait)
